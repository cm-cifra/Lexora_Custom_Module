...
class ProductKits(models.Model):
    ...
    image_kit_custom = fields.Image(string="Manual Kit Image")
    ...
    cabinet_image = fields.Image(string="Cabinet Image")
    counter_top_image = fields.Image(string="Counter Top Image")
    faucet_image = fields.Image(string="Faucet Image")
    mirror_image = fields.Image(string="Mirror Image")
    # Product relations
    ...
    @api.depends('image_kit_custom', 'product_id.image_1920')
    def _compute_image_1920(self):
        for kit in self:
            if kit.image_kit_custom:
                kit.image_1920 = kit.image_kit_custom
    ...
    def _inverse_image_1920(self):
        for kit in self:
            kit.image_kit_custom = kit.image_1920
